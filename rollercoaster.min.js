...
w.prototype.step=function(a){var b=a/2,d=this.e(this.c,this.y,this.k),c=this.e(this.c+b,y(this.y,d,b),this.k),e=this.e(this.c+b,y(this.y,c,b),this.k),f=this.e(this.c+a,y(this.y,e,a),this.k),h=a/6;this.y.forEach(function(a,b,x){x[b]=a+h*(d[b]+2*c[b]+2*e[b]+f[b])},this);this.c+=a};function y(a,b,d){var c=[];a.forEach(function(a,f){c.push(a+b[f]*d)});return c};function u(a,b,d,c){a.beginPath();a.arc(b,d,c,0,2*Math.PI,!1);a.fill()};function g(a,b,d,c,e,f,h,A,B,x,C,D,E,F,G){this.canvas=a;this.b=this.canvas.getContext("2d");this.T=d;this.T.onclick=this.start.bind(this);this.U=c;this.U.onclick=this.stop.bind(this);this.u=B;this.u.onchange=this.r.bind(this);this.v=x;this.v.onchange=this.r.bind(this);this.R=e;this.R.onclick=this.r.bind(this);this.M=b;this.F=C;this.F.onchange=this.S.bind(this);this.B=D;this.$=this.B.checked;this.N=h;this.O=A;this.D=E;this.ca=F;this.Y=G;this.D.onchange=this.H.bind(this);this.P=f;this.g={};this.S();
this.H();this.A=new s(this.canvas);this.r();this.ja=10/60;this.t=!1}g.prototype.r=function(){var a=this.A,b=parseInt(this.u.value,10)-1,d=parseInt(this.v.value,10),c=[];a.n=[];a.l=!1;a.p=-1;for(var e=new k(a.aa,a.canvas.height/2),f=(new k(a.canvas.width-a.aa,a.canvas.height/2)).sub(e),h=0;h<=b;h++)c.push(e.add(l(f,h/b))),a.n.push(0);a.d=0===d?new n(c):new q(c);t(a);this.g.I=new k(this.canvas.width/2,this.canvas.height/2)};
g.prototype.S=function(){var a=0.001*parseFloat(this.M.value);this.f=0===parseInt(this.F.value,10)?new v(z,a,this.g):new w(z,a,this.g)};g.prototype.H=function(){this.da=parseInt(this.D.value,10);0===this.da?(this.f.e=z,this.g.m=-1*parseFloat(this.N.value),this.ca.style.display="block",this.Y.style.display="none"):(this.f.e=H,this.g.m=1E3*parseFloat(this.O.value),this.Y.style.display="block",this.ca.style.display="none")};
g.prototype.start=function(){this.g.d=this.A.d;this.S();this.H();this.g.C=parseFloat(this.P.value);this.f.c=null;this.f.y=[0,0];this.T.style.display="none";this.U.style.display="inline";this.R.disabled=!0;this.N.disabled=!0;this.O.disabled=!0;this.D.disabled=!0;this.P.disabled=!0;this.M.disabled=!0;this.F.disabled=!0;this.B.disabled=!0;this.u.disabled=!0;this.t=this.v.disabled=!0;this.$=this.B.checked};
...
g.prototype.L=function(a){this.b.clearRect(0,0,this.canvas.width,this.canvas.height);1===this.da&&(this.b.fillStyle="#b58900",u(this.b,this.g.I.x,this.g.I.y,20));this.A.L(!this.t);if(!0===this.t)if(a*=0.001,null===this.f.c&&(this.f.c=a),a-this.f.c>this.ja&&(this.f.c=a),this.f.ba(a),1>=this.f.y[0]&&0<=this.f.y[0]){a=this.A.d.e(this.f.y[0]);if(!0===this.$){this.b.strokeStyle="#859900";this.b.lineWidth=3;var b=this.b,d=new k(this.g.W,this.g.X),c=b.lineWidth;b.save();b.translate(a.x,a.y);b.rotate(Math.atan2(d.y,
